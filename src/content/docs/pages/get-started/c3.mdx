...
Cloudflare collects telemetry about your usage of `create-cloudflare` to improve the experience. Read more about our data policy at [the repository](https://github.com/cloudflare/workers-sdk/blob/main/packages/create-cloudflare/telemetry.md).
